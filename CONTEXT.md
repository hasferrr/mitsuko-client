...
A Context Extraction created for or explicitly linked to one Translation as part of Auto Context. It is detached and retained in its existing project when that Translation is moved or deleted.
