...
export function SettingsTranscription({ transcriptionId }: SettingsTranscriptionProps) {
  ...
  const selectedModel = useTranscriptionDataStore((state) => state.getModels(transcriptionId))
  const selectedMode = useTranscriptionDataStore((state) => state.getSelectedMode(transcriptionId))
  const selectedLanguage = useTranscriptionDataStore((state) => state.getLanguage(transcriptionId))
  const customInstructions = useTranscriptionDataStore((state) => state.getCustomInstructions(transcriptionId))
